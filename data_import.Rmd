...
```{r}
pups_df <- read_csv("/Users/chhiringlama2/OneDrive - Columbia University Irving Medical Center/Course Materials/Data Science 1/20240917_Data_wrangling1/Data/FAS_pups.csv")
head(pups_df)
```
